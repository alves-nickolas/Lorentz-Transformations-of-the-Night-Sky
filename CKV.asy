...
for (int i = 1; i < bigdipper.length; ++i){
    ...
    draw(Arc((0,0,0), star0, star1), starpen+linewidth(magscale(7))); // draws an arc connecting two consecutive stars
}